...
public class GeometryUtils {
     ...
     * @return
     */
    public static float getDistanceBetweenPoints(PointF p0, PointF p1) {
    ...
    /**
     * 根据分度值,计算从start到end中,percent位置的值.percent范围为0->1
     *
     * @param percent
     * @param start
     * @param end
     ...
     * @param lineK   The slope of line whice cross the pMiddle
     * @return
     */
